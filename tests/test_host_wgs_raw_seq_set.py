...
""" A unittest script for the HostWgsRawSeqSet module. """
...
class HostWgsRawSeqSetTest(unittest.TestCase):
    """" A unit test class for the HostWgsRawSeqSet class. """
    ...
    def testImport(self):
        """ Test the importation of the HostWgsRawSeqSet module. """
        success = False
        try:
            from cutlass import HostWgsRawSeqSet
            success = True
    ...
    def testSessionCreate(self):
        """ Test the creation of a HostWgsRawSeqSet via the session. """
        success = False
        seq_set = None
    ...
    def testToJson(self):
        """ Test the generation of JSON from a HostWgsRawSeqSet instance. """
        seq_set = self.session.create_object("host_wgs_raw_seq_set")
        success = False
