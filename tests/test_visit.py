...
class VisitTest(unittest.TestCase):
    ...
    def testToJson(self):
        ...
        self.assertTrue(visit_data is not None, "to_json() returned parsable JSON.")
    ...
    def testVisitNumLegal(self):
        ...
        self.assertEqual(visit.visit_number, visit_number, "Property getter for 'visit_number' works.")
    ...
    def testLoadSaveDeleteVisit(self):
        #attempt to save the visit at all points before and after adding the required fields
        #project_id = super(VisitTest, self).testSaveProject()
        ...
        self.assertEqual(visit.date, visit_loaded.date, "Visit date not saved & loaded successfully")        
        self.assertEqual(visit.visit_number, visit_loaded.visit_number, "Visit visit_number not saved & loaded successfully")
        self.assertEqual(visit.interval, visit_loaded.interval, "Visit interval not saved & loaded successfully")
